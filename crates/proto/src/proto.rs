...
messages!(
    ...
    (CompareGitRevisions, Foreground),
    (CompareGitRevisionsResponse, Foreground),
    ...
    (GitReset, Background),
    (GitOperationRequest, Background),
    (GitOperationActionRequest, Background),
    (GitOperationResponse, Background),
...
request_messages!(
    ...
    (CompareGitRevisions, CompareGitRevisionsResponse),
    ...
    (GitReset, Ack),
    (GitOperationRequest, GitOperationResponse),
    (GitOperationActionRequest, GitOperationResponse),
    (GitDeleteBranch, Ack),
